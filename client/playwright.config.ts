...
const specs: { name: string; monsters?: number; env?: Record<string, string> }[] = [
  ...
  { name: "skills" },
  // evade (#322): the universal mechanic — Space arms it, a click on a painted
  // tile spends it. Monster-free: the spec is about the arm, the overlay and
  ...
  // melee-feedback (#113) must land a real melee CLICK with its own player, so
