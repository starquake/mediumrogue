...
- **Persistence** starts as "in memory + periodic JSON snapshot to disk" — 15 players don't need a database on day one. **Upgrade path (decided 2026-07-10): SQLite for runtime *state*; the repo for *content*.**
